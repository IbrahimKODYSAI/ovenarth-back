let User,bcrypt,jwt,AWS,dotenv,nanoid,registerValidation,loginValidation,passwordResetValidation;_f0f‍.x([["forgotPassword",()=>forgotPassword],["default",()=>_f0f‍.o]]);_f0f‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_f0f‍.w("bcrypt",[["default",["bcrypt"],function(v){bcrypt=v}]]);_f0f‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_f0f‍.w("aws-sdk",[["default",["AWS"],function(v){AWS=v}]]);_f0f‍.w("dotenv",[["default",["dotenv"],function(v){dotenv=v}]]);_f0f‍.w("nanoid",[["default",["nanoid"],function(v){nanoid=v}]]);_f0f‍.w("../validation",[["registerValidation",["registerValidation"],function(v){registerValidation=v}],["loginValidation",["loginValidation"],function(v){loginValidation=v}],["passwordResetValidation",["passwordResetValidation"],function(v){passwordResetValidation=v}]]);
