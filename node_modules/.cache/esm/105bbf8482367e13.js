let Course,dotenv,AWS,nanoid,slugify,readFileSync,express,course,exec,stringify;_823‍.x([["courses",()=>courses],["default",()=>_823‍.o]]);_823‍.w("../models/course",[["default",["Course","course"],function(v){Course=course=v}]]);_823‍.w("dotenv",[["default",["dotenv"],function(v){dotenv=v}]]);_823‍.w("aws-sdk",[["default",["AWS"],function(v){AWS=v}]]);_823‍.w("nanoid",[["default",["nanoid"],function(v){nanoid=v}]]);_823‍.w("slugify",[["default",["slugify"],function(v){slugify=v}]]);_823‍.w("fs",[["readFileSync",["readFileSync"],function(v){readFileSync=v}]]);_823‍.w("express",[["default",["express"],function(v){express=v}]]);_823‍.w("child_process",[["exec",["exec"],function(v){exec=v}]]);_823‍.w("querystring",[["stringify",["stringify"],function(v){stringify=v}]]);
...
const uploadImage = async (req, res) => {
  try {
    ...
    S3.upload(params, (err, data) => {
      if (err) {
        _823‍.g.console.log(err);
        return res.sendStatus(400);
      }

      _823‍.g.console.log(data);
      res.send(data);
    });
  } catch (err) {
    _823‍.g.console.log(err);
...
const updateLesson = async (req, res) => {
  try {
    ...
    res.json({ ok: true });
    _823‍.g.console.log("updated", updated);
  } catch (err) {
    _823‍.g.console.log(err);
